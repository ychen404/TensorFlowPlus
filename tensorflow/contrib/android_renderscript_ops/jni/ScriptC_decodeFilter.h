 ...
 * The source Renderscript file: decodeFilter.rs
 */
 ...
 */
class ScriptC_decodeFilter : public android::RSC::ScriptC {
private:
...
public:
    ScriptC_decodeFilter(android::RSC::sp<android::RSC::RS> rs);
    virtual ~ScriptC_decodeFilter();
     ...
     */
    void set_filterW(int32_t v) {
        setVar(0, &v, sizeof(v));
        mExportVar_filterW = v;
    }

    int32_t get_filterW() const {
        return mExportVar_filterW;
    }
