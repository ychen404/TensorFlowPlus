 ...
 * The source Renderscript file: utils.rs
 */
 ...
 */
class ScriptC_utils : public android::RSC::ScriptC {
private:
...
public:
    ScriptC_utils(android::RSC::sp<android::RSC::RS> rs);
    virtual ~ScriptC_utils();
