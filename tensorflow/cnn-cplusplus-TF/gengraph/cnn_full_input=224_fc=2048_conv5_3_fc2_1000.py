...
with tf.Session() as sess:
    ...
    with tf.name_scope('fc2') as scope:
        fc2w = tf.Variable (tf.truncated_normal ([2048, 1000],stddev=1e-2),name='weights')
    ...
    tf.train.write_graph (sess.graph_def, "models/", "graph_full_224_fc_2048_conv5_3_fc2_1000.pb", as_text=False)
