...
with tf.Session() as sess:
	...
	images_placeholder = tf.placeholder (tf.float32, shape=(BATCH_SIZE, IMAGE_HEIGHT*IMAGE_WIDTH), name="input")
...
#	train_op = optimizer.minimize (loss, global_step=global_step, name="train")
	...
	tf.train.write_graph (sess.graph_def, "models/", "graph_simplified.pb", as_text=False)
